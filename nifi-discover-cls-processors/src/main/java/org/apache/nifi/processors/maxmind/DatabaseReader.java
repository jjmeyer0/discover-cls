...
/**
 * NOTE: copied this class over from NiFi. Our work with GeoEnrichEnriched should be proposed to go into NiFi community. It's a decently simple change to the main code. We should file a Jira
 * and try to merge our work in.
 *
 * <p>
...
public class DatabaseReader implements GeoIp2Provider, Closeable {
    ...
    public final static class Builder {
         ...
         * @return Builder object
         * @throws IllegalArgumentException if you initialized the Builder with a URL, which uses {@link FileMode#MEMORY}, but you provided a different FileMode to this method.
         */
